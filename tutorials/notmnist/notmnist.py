...
def maybe_extract(filename, force=False):
	...
	if os.path.isdir(root) and not force:
		...
		print('%s already prenset - Skipping extraction of %s.' % (root, filename))
	else:
...
#img = imread('/home/williamn/Repository/data/nomnist/notMNIST_small/F/SHVtYW5pc3QgU2xhYnNlcmlmIDcxMi5wZmI=.png')
#plt.imshow(img)
#plt.show()
